...
static u_char ngx_http_server_string[] = "Server: lucat" CRLF;
static u_char ngx_http_server_full_string[] = "Server: lucat" CRLF;
static u_char ngx_http_server_build_string[] = "Server: lucat" NGINX_VER_BUILD CRLF;
